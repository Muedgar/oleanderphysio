...
return(
    ...
    <div className="banner">
        ...
        <div>
            <span className="banner-wide"><span>88 broklyn silver street, USA</span></span>
            <span><span>Mon to Fri 9:00am to 6:00pm</span></span>
        </div>
    </div>
    <nav className="nav_clinic">
        <div className="nav_clinic_container">
            <p className="logo"><span>Oleander</span><span>Physiotherapy</span></p>
            <div className="contacts">
                ...
                <button className="call_to_action_button hover:shadow-lg hover:animate-pulse outline-none">Book an appointment</button>
            </div>
