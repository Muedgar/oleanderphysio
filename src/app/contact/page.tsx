...
export default function Contact() {
    return(
        <div className="w-screen h-fit flex flex-col justify-center items-center">
            ...
            <div className="w-[300px] h-fit rounded-lg border mb-10 flex flex-col p-4 justify-start items-start">
                <FontAwesomeIcon className="text-[1em] bg-green-400 p-4 rounded-md" icon={faMessage}/>
                <p className="mt-4">Chat with our physiotherapists</p>
                <p className="text-slate-500">We're here help</p>
                <button className="bg-green-400 text-white p-2 mt-2 rounded-md shadow-sm shadow-black hover:shadow-lg">Chat With Us</button>
            </div>  
  ...
  <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    ...
    <div className="mb-6">
      ...
      <textarea name="message" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter Message" />
    </div>
